...
return new class extends Migration
{
    ...
    {
        Schema::create('cg_signal_dataset_archive', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['symbol', 'interval', 'generated_at'], 'cg_signal_dataset_archive_symbol_interval_time_idx');
            $table->index(['generated_at'], 'cg_signal_dataset_archive_generated_at_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('cg_signal_dataset_archive');
    }
};