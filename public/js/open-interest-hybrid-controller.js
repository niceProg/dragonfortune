...
function openInterestHybridController() {
    return {
        // Global state
        ...
        renderChart() {
            const canvas = document.getElementById('openInterestMainChart');
            if (!canvas) {
...
window.openInterestHybridController = openInterestHybridController;